...
p,om=fl['fields/T'],fl['fields/Om']
Lx,Ly,a,b,chi,kapt,nuH,nuL=[fl['params'][l][()] for l in ['Lx', 'Ly', 'a', 'b', 'chi', 'kapt', 'nuH', 'nuL']]
...
if comm.rank==0:
    ...
    fig.text(0.1, 0.75, f"Box size : $[L_x,L_y]=[{Lx:.2f},{Ly:.2f}]$",fontsize=16,ha='left')
    fig.text(0.1, 0.69, f"$\\chi = {chi}$, $\\kappa_T={kapt}$",fontsize=16,ha='left')
